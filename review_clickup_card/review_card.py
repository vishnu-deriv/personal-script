...
# Please pass the link of the tag card as an argument when running the script
...
if len(sys.argv) != 2:
    sys.exit("Program terminated unexpectedly: did you pass the link of the tag card?")
